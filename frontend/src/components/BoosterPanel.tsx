...
import { Bomb, RefreshCw, AlignCenterVertical } from 'lucide-react';
...
export default function BoosterPanel({
  ...
  const boosters = [
    ...
    },
    {
      ...
      image: '/assets/generated/fruit-change-booster-icon-transparent.dim_64x64.png',
    },
    {
      ...
      image: '/assets/generated/alignment-booster-icon-transparent.dim_64x64.png',
    },
  ];
  ...
  return (
    <Card className="booster-card">
      <CardHeader className="booster-card-header">
        <CardTitle className="booster-card-title">{t('booster.title')}</CardTitle>
              ...
              >
                ...
                <div className="booster-icon-wrapper">
                  ...
                  {isActive && (
                    <div className="booster-active-badge">
                      <Badge variant="default" className="h-3 px-0.5 text-[9px] leading-none">
                        {t('booster.active')}
                      </Badge>
                    </div>
                  )}
                ...
                <div className="booster-actions">
                  ...
                  >
                    ...
                    <span className="booster-button-text">{t('booster.use')}</span>
                  </Button>
                </div>
              </div>
            );

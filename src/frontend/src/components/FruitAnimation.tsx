...
export default function FruitAnimation({ theme }: FruitAnimationProps) {
  ...
  useEffect(() => {
    ...
    const imagePaths = {
      tropical: [
        "/assets/generated/pineapple-float.dim_64x64.png",
        "/assets/generated/orange-spin.dim_64x64.png",
      ],
      berry: [
        "/assets/generated/strawberry-bounce.dim_64x64.png",
        "/assets/generated/blueberry-sway.dim_64x64.png",
      ],
      citrus: [
        "/assets/generated/lemon-glow.dim_64x64.png",
        "/assets/generated/orange-spin.dim_64x64.png",
      ],
    };
    ...
    for (const path of imagePaths[theme]) {
      const img = new Image();
      img.src = path;
      img.onload = () => {
        imagesLoaded++;

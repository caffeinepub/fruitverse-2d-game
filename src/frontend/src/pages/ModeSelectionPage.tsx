...
import { Apple, Infinity as InfinityIcon, Puzzle, Zap } from "lucide-react";
                ...
                >
                  <CardHeader className="text-center pb-4">
                    <div className="flex justify-center mb-4">
                      <div
                        className={`w-20 h-20 rounded-full bg-gradient-to-br ${mode.color} flex items-center justify-center shadow-lg`}
                      >
                        <img
                          src={mode.iconSrc}
                          alt={mode.title}
